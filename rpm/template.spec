...
%description
ROS2 VRPN client built primarily to interface with motion capture devices such
as VICON and OptiTrack. A detailed list of supported hardware can be found here.
...
%changelog
* Fri Mar 22 2024 Alvin Sun <alvinsunyixiao@gmail.com> - 1.1.0-2
